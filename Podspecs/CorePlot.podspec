Pod::Spec.new do |s|
  ...
  s.source   = { :http => 'http://core-plot.googlecode.com/archive/release-2.0.zip' }
  ...
  s.requires_arc = true
  #s.xcconfig = { 'HEADER_SEARCH_PATHS' => "\"$(SDK_DIR)/System/Library/Frameworks/Accelerate.framework/Headers\"" }
  s.prefix_header_contents = '#import <Accelerate/Accelerate.h>'
  s.prepare_command = <<-CMD
    mv **/framework ./framework
