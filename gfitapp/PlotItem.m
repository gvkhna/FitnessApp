...
//+(void)registerPlotItem:(instancetype)item
//{
...
-(instancetype)init {
    ...
    self.graphs = [[NSMutableArray alloc] initWithCapacity:1];
...
#endif
{
    ...
    self.defaultLayerHostingView = [[CPTGraphHostingView alloc] initWithFrame:hostingView.bounds];
...
-(instancetype)imageRepresentation
{
    return [self image];
}
